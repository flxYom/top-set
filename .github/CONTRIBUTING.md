...
The most useful contribution is a good [issue](https://github.com/flxYom/top-set/issues/new/choose):
...
[Running it locally](../docs/en/technical.md#running-it-locally) section for the one
...
`mentions-legales.html` are static pages sharing `css/legal.css`.
...
README's [Project structure](../docs/en/technical.md#project-structure) section for
the full list.
