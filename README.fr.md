...
ça marche hors connexion, aucun serveur à payer.
...
C'est une PWA : elle s'installe sans passer par un store, obtient son icône,
s'ouvre en plein écran et fonctionne hors connexion.
...
Les comptes et la synchronisation sont l'étape suivante évidente, et le schéma
