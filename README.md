...
test/                    business logic (146), hardening guards (163), links (47)
...
(`/methode-editoriale`). The app footer links to them (**Apprendre**) — the only
change to `index.html`; the service worker is unchanged, and every visited page
stays readable offline. First pages: the top set, a 1RM calculator, the product
