...
| Exercice | `execution`, `erreurs`, `variantes` | **fiche** : muscles, matériel, niveau, mouvement (amplitude et trajectoire), respiration, avant le sommaire ; au moins une notion liée, et un exercice lié dès qu'au moins trois autres fiches existent |
| Guide, outil | libres | — |
...
| 11/09/2026 | Un exercice n'exige un exercice lié qu'à partir de trois autres fiches : relier le développé couché à la planche, seules fiches existantes, aurait été un lien artificiel. Poids des barres autres que la barre olympique : aucun chiffre publié, faute de source ouverte (site de l'IWF derrière un contrôle anti-robots, pages de fabricants refusées) ; la page le dit. |
